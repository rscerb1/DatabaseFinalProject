...
CREATE TABLE IF NOT EXISTS `dbproj`.`SPECIES` (
  `is_recreational` TINYINT(4) NULL DEFAULT NULL,
  `is_aquatic` TINYINT(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `dbproj`.`HATCHED_DISTRIBUTION` (
  `Average_length` INT NULL DEFAULT NULL,
  `life_stage` VARCHAR(45) NOT NULL,
  `Average_weight` INT NULL DEFAULT NULL,
